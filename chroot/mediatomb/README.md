...
> Также автоматическую установку можно запустить отдельно. Скачиваем [репу](https://github.com/FLANKERSPb/MyBookLive/archive/master.zip), разархивируем и закидываем на MBL в любую папку шары. 
